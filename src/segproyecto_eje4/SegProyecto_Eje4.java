        ...
        do {
            ...
            switch (opc) {
                                                      ...
                                                      case 3:
                                                       ...
                                                       case 4:
                                                         ...
                                                         + "\n ID: " + clientesi.getId();
                                                              ...
                                                              }else JOptionPane.showMessageDialog(null, "No se encuentra ese usuario");
                                                              
                                                              JOptionPane.showMessageDialog(null, temp);
                                                          }
                                                              break;
                                                       case 5: JOptionPane.showMessageDialog(null, "APLICACION FINALIZDA");
                                                              break;
                                                         ...
                                                         + "\n Genero de la pelicula: " + peli.getGenero()
                                                          ...
                                                          + "\n Descripcion de la pelicula: " + peli.getDescripcion()
                                                           + "\n Duracion de la pelicula en minutos: " + peli.getDuracion();
                                                              ...
                                                              }else JOptionPane.showMessageDialog(null, "No se encuentra esta pelicula");
                                                         ...
                                                         + "\n Genero de la serie: " + ser.getGenero()
                                                          + "\n Nombre del director de la serie: " + ser.getDirector()
                                                           ...
                                                           + "\n Cantidad de capitulos de la serie: " + ser.getCapitulos();
                                                              ...
                                                              }else JOptionPane.showMessageDialog(null, "No se encuentra esta serie");
                                                         ...
                                                         + "\n Genero del domuental: " + doc.getGenero()
                                                          + "\n Nombre del director del documental " + doc.getDirector()
                                                           ...
                                                           + "\n Duracion en minutos del documental: " + doc.getDuracion();
                                                              ...
                                                              }else JOptionPane.showMessageDialog(null, "No se encuentra el documental");
                ...
                case 7:
                    ...
                    break;
                case 8: JOptionPane.showMessageDialog(null, "APLICACION FINALIZDA");
                      break;
